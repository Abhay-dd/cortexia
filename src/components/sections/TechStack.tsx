...
const STACK = [
  { name: "OpenAI", role: "LLMs & Foundation Models", accent: "#FFFFFF" },
...
export default function TechStack() {
  return (
    <section id="technology" className="section bg-ambient-mesh">
      <div className="container">

        <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
          <div>
            <div className="badge-minimal mb-4">Infrastructure & Tools</div>
            <h2 className="font-display text-[clamp(2.2rem,4vw,3.5rem)] font-extrabold text-white leading-[1.08]">
              Engineered with <br />
              <span className="text-gradient-white">Battle-Tested Tech.</span>
            </h2>
          </div>
          <div>
